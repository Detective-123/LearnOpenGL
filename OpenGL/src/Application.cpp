...
int main()
{
    ...
    Shader lightingShader("res/shaders/vecColor.glsl", "res/shaders/fragColor.glsl");
    Shader lightCubeShader("res/shaders/vecLight_cube.glsl", "res/shaders/fragLight_cube.glsl");
    ...
    // position of all the pointLights
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setFloat("pointLights[1].quadratic", 0.7f);
        // point light 3
